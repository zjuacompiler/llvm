...
void X86TargetLowering::resetOperationActions() {
  ...
  if (!TM.Options.UseSoftFloat && Subtarget->hasSSE2()) {
    ...
    setOperationAction(ISD::ADD,                MVT::v64i2, Custom);
    setOperationAction(ISD::MUL,                MVT::v4i32, Custom);
    setOperationAction(ISD::MUL,                MVT::v2i64, Custom);
    setOperationAction(ISD::MUL,                MVT::v64i2, Custom);
    setOperationAction(ISD::SUB,                MVT::v16i8, Legal);
    setOperationAction(ISD::SUB,                MVT::v8i16, Legal);
    setOperationAction(ISD::SUB,                MVT::v4i32, Legal);
    setOperationAction(ISD::SUB,                MVT::v2i64, Legal);
    setOperationAction(ISD::SUB,                MVT::v64i2, Custom);
    ...
    setOperationAction(ISD::SETCC,              MVT::v64i2, Custom);
    ...
    setOperationAction(ISD::BUILD_VECTOR,       MVT::v64i2, Custom);
    setOperationAction(ISD::VECTOR_SHUFFLE,     MVT::v2f64, Custom);
    setOperationAction(ISD::VECTOR_SHUFFLE,     MVT::v2i64, Custom);
    setOperationAction(ISD::VECTOR_SHUFFLE,     MVT::v64i2, Custom);
    setOperationAction(ISD::INSERT_VECTOR_ELT,  MVT::v2f64, Custom);
    setOperationAction(ISD::EXTRACT_VECTOR_ELT, MVT::v2f64, Custom);

    if (Subtarget->is64Bit()) {
      setOperationAction(ISD::INSERT_VECTOR_ELT,  MVT::v2i64, Custom);
      setOperationAction(ISD::INSERT_VECTOR_ELT,  MVT::v64i2, Custom);
      setOperationAction(ISD::EXTRACT_VECTOR_ELT, MVT::v2i64, Custom);
      setOperationAction(ISD::EXTRACT_VECTOR_ELT, MVT::v64i2, Custom);
    }
  ...
  if (!TM.Options.UseSoftFloat && Subtarget->hasSSE41()) {
    ...
    setOperationAction(ISD::VSELECT,            MVT::v64i2, Legal);
  ...
  if (Subtarget->hasSSE2()) {
    ...
    setOperationAction(ISD::SRL,               MVT::v64i2, Custom);
...
X86TargetLowering::findRepresentativeClass(MVT VT) const{
  ...
  case MVT::v4f32: case MVT::v2f64: case MVT::v64i2:
...
static SDValue Lowerv64i2Add(SDValue Op, SelectionDAG &DAG) {
  ...
  // get bit add using xor
  SDValue BitAdd = DAG.getNode(ISD::XOR, dl, VT, A, B);

  // get carry bits
  SDValue Carry1 = DAG.getNode(ISD::AND, dl, VT, A, B);
  ...
  SDValue Result = DAG.getNode(ISD::XOR, dl, VT, BitAdd, Carry3);
